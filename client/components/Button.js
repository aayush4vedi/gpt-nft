...
const style = {
    blue: `bg-[#27F3CB] hover:bg-gradient-to-b hover:from-[#9ffcea] hover:to-[#00f1c2] text-slate-800`,
    yellow: `bg-gradient-to-b from-amber-300 to-amber-400 hover:from-amber-200 hover:to-amber-300 text-slate-800`,
    teal: `bg-gradient-to-b from-teal-600 to-teal-700 hover:from-teal-400 hover:to-teal-600 text-slate-800`,
}

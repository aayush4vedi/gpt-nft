        ...
        <section className="py-8 pl-5 pr-2">
            <div className="container mx-auto flex items-center justify-between">
                <div className="md:w-3/5 pr-20">
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-lato font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-100 via-amber-200 to-amber-200">
                        GPT Meets NFTs
                    </h1>
                    <h1 className="text-md md:text-xl lg:text-2xl leading-10 tracking-wide font-lato font-extrabold uppercase text-transparent bg-clip-text bg-gradient-to-r from-amber-100 via-amber-200 to-amber-200">
                        :Future of Digital Art is here
                    </h1>
                    <p className="text-xs md:text-base  text-zinc-400 mt-7">
                    ...
                    <p className="text-xs md:text-base font-bold text-zinc-400 mt-4">
                        Join the revolution of digital art and own a piece of the future!
                    </p>
                </div>
                <div className="hidden md:block md:w-2/5">
                    <div className="flex flex-col p-4 rounded-3xl shadow-lg items-center justify-between h-[15rem] bg-gradient-to-tl from-zinc-800 via-zinc-700 to-zinc-600">
                        <div className=" text-zinc-300 text-md font-bold uppercase">
                                Your Portfolio
                        </div>
